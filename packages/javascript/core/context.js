...
function Context(data) {
  ...
  /**
   * Immutable context with careful handling—holds data without judgment, returns fresh copies for changes.
   * Enhanced with generic typing for type-safe workflows.
   *
 ...
 */
Context.prototype.insert = function(key, value) {
 ...
 */
Context.prototype.insertAs = function(key, value) {
  const newData = { ...this._data, [key]: value };
  return new Context(newData);
};
 ...
 */
Context.prototype.withMutation = function() {
 ...
 */
Context.prototype.merge = function(other) {
 ...
 * @template T
 */
function MutableContext(data) {
  // Support both ES5 .call() and ES6 new instantiation
  if (!(this instanceof MutableContext)) {
    return new MutableContext(data);
  }
 ...
 * console.log(ctx.get('name')); // 'Alice'
 */
MutableContext.prototype.get = function(key) {
 ...
 */
MutableContext.prototype.set = function(key, value) {
 ...
 */
MutableContext.prototype.toImmutable = function() {
 ...
 * @returns {boolean} True if the key exists, false otherwise
 */
MutableContext.prototype.has = function(key) {
  return key in this._data;
};
 ...
 * @returns {string[]} Array of all keys in the context
 */
MutableContext.prototype.keys = function() {
  return Object.keys(this._data);
};
 ...
 */
MutableContext.prototype.toString = function() {
