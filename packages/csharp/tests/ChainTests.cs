...
public class ChainTests
{
    ...
    public async Task RunAsync_LinkThrowsException_ShouldExecuteErrorMiddleware()
    {
        ...
        await Assert.ThrowsAsync<Exception>(() => chain.RunAsync(context));
...
public class TestLink : ILink
{
    ...
    {
        return context.Insert("output", "processed");
    }
}
...
public class ErrorMiddleware : IMiddleware
{
    ...
    public Task<Context> BeforeAsync(ILink? link, Context context) => Task.FromResult(context);
    public Task<Context> AfterAsync(ILink? link, Context context) => Task.FromResult(context);
